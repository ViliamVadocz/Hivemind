...
public struct PlayerInfo : IFlatbufferObject
{
  ...
  public BoxShape? Hitbox { get { int o = __p.__offset(26); return o != 0 ? (BoxShape?)(new BoxShape()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public Vector3? HitboxOffset { get { int o = __p.__offset(28); return o != 0 ? (Vector3?)(new Vector3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void StartPlayerInfo(FlatBufferBuilder builder) { builder.StartObject(14); }
  ...
  public static void AddHitbox(FlatBufferBuilder builder, Offset<BoxShape> hitboxOffset) { builder.AddOffset(11, hitboxOffset.Value, 0); }
  public static void AddHitboxOffset(FlatBufferBuilder builder, Offset<Vector3> hitboxOffsetOffset) { builder.AddStruct(12, hitboxOffsetOffset.Value, 0); }
